...
<AdapterType Name="STRING_SPLIT_N">
  ...
  <InterfaceList>
    ...
    <InputVars>
      <VarDeclaration Comment="Request Data from Socket" Name="REQD" Type="WSTRING"/>
      <VarDeclaration Comment="Response Data from Socket" Name="RSPD" Type="WSTRING"/>
    </InputVars>
    <OutputVars>
      <VarDeclaration Comment="Confirmation Data from Plug" Name="CNFD" Type="WSTRING"/>
      <VarDeclaration Comment="Indication Data from Plug" Name="INDD" Type="WSTRING"/>
    </OutputVars>
  </InterfaceList>
